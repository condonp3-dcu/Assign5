...
public class CustDatabaseHelper extends SQLiteOpenHelper{
    ...
    */
    ...
    /**
    * Use Cursor the check if Product Table exists . If cursor returns no data the no table exists
    * so create a Product table also:
    */
        String sql = "SELECT name FROM sqlite_master WHERE type='table' AND name='" + Product.TABLE + "'";
    ...
    /**
     * @param db
     * @param oldVersion of the table
     * @param newVersion of the table
     * drop older table if it existed and create the table again
     */
    @Override
